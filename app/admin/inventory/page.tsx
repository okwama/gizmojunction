    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-black tracking-tight text-neutral-900 dark:text-white">Inventory Control</h1>
                    <p className="text-xs text-neutral-500 font-medium mt-0.5">Manage stock levels across all active warehouses.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-neutral-900 p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all">
                    ...
                    <div className="mt-5">
                        <h3 className="text-2xl font-black text-neutral-900 dark:text-white">{totalItems}</h3>
                        <p className="text-[10px] font-bold text-neutral-500 mt-1 uppercase tracking-wider">Total Units in Stock</p>
                    </div>
                ...
                <div className="bg-white dark:bg-neutral-900 p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all">
                    ...
                    <div className="mt-5">
                        <h3 className="text-2xl font-black text-neutral-900 dark:text-white">{lowStockCount}</h3>
                        <p className="text-[10px] font-bold text-neutral-500 mt-1 uppercase tracking-wider">Low Stock SKU Alerts</p>
                    </div>
                ...
                <div className="bg-white dark:bg-neutral-900 p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all">
                    ...
                    <div className="mt-5">
                        <h3 className="text-2xl font-black text-neutral-900 dark:text-white">{warehouses?.length || 0}</h3>
                        <p className="text-[10px] font-bold text-neutral-400 mt-1 uppercase tracking-wider">Active Warehouses</p>
                    </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 items-start">
                {/* Stock Table */}
                <div className="xl:col-span-2 bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm overflow-hidden min-h-[600px] flex flex-col">
                    <div className="p-6 border-b border-neutral-100 dark:border-neutral-800 flex items-center justify-between">
                        <div>
                            <h3 className="text-lg font-black">Stock Ledger</h3>
                            <p className="text-xs text-neutral-500 font-medium leading-none mt-1">Detailed inventory levels by warehouse.</p>
                        </div>
                    ...
                    <div className="flex-1 overflow-x-auto">
                        <table className="w-full text-left">
                            <thead className="bg-neutral-50/50 dark:bg-neutral-800/30 border-b border-neutral-100 dark:border-neutral-800">
                                <tr>
                                    <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-neutral-400">Product / SKU</th>
                                    <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-neutral-400">Warehouse</th>
                                    <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-neutral-400">Quantity</th>
                                    <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-neutral-400">Status</th>
                                    <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-neutral-400">Last Sync</th>
                                </tr>
                            </thead>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm overflow-hidden flex flex-col">
                        <div className="p-6 border-b border-neutral-100 dark:border-neutral-800">
                            ...
                            <p className="text-[10px] text-neutral-500 font-black mt-1 uppercase tracking-widest">Recent movements</p>
                        </div>
